...
const SKILL_CD = { sk_meteor: lv => 9 - lv * 0.8, sk_chain: lv => 6 - lv * 0.5, sk_nova: lv => 7 - lv * 0.5, sk_fire: lv => 8 - lv * 0.6, sk_holy: lv => 12 - lv, lg_time: lv => 22 - lv * 4 };
const SKILL_DMG = { sk_meteor: 1200, sk_chain: 700, sk_nova: 500, sk_fire: 610, sk_holy: 560, sk_blade: 350, sk_spike: 200, lg_judge: 3400 };
